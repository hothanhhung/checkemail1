...
<div class="login-class">
	 <form method="post" class="signin" action="<?php echo base_url()?>index.php/member/index/login">
		<fieldset class="textbox">
			<label style="padding:0px 0px 15px 0px;">
				<span>Email</span>
				<input id="email-signin" name="email-signin" value="" type="text" autocomplete="on" placeholder="Địa chỉ Email">
			</label>
			<label style="padding:0px 0px 15px 0px;">
				<span>Mật khẩu</span>
			...
			<div style="color:red;font-size: 14px;">
				<?php if(isset($errorlogin) && $errorlogin==1) echo "Email và mật khẩu không khớp"; ?>
			</div>
